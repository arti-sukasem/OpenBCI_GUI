    ...
    private void defineFilters() {
        ...
        for (int Ifilt=0; Ifilt < n_filt; Ifilt++) {
            ...
            for (int Ifilt=0; Ifilt<n_filt; Ifilt++) {
                ...
                break;
                case 1:
                    //0 - 0.5 Hz band pass filter, 4nd Order Butterworth: [b, a] = butter(4,[0.0 0.5]/(fs_Hz / 2.0))
                    switch(int(fs_Hz)) {
                        case 125:
                            b = new double[] {0.000000024136223172877,    0.00000009654489269150801,      0.000000144817339037262,    0.00000009654489269150801,       0.000000024136223172877};
                            a = new double[] { 1.0, -3.934325820798739, 5.805125421055145, -3.807232457228856, 0.9364332431520201};
                            break;
                        case 200:
                            b = new double[] { 0.000000003728051617413186,    0.00000001491220646965274,    0.00000002236830970447912,    0.00000001491220646965274,    0.000000003728051617413186};
                            a = new double[] { 1.0, -3.958953318647085, 5.877700273536147, -3.878530549051737, 0.9597836538114999};
                            break;
                        case 250:
                            b = new double[] { 0.000000001533245558293928,    0.00000000613298223317571,   0.000000009199473349763565,    0.00000000613298223317571,    0.000000001533245558293928};
                            a = new double[] { 1.0, -3.967162595948849, 5.902025861490881, -3.902558784823242, 0.9676955438131379};
                            break;
                        case 500:
                            b = new double[] { 0.00000000009661402233795968,  0.0000000003864560893518387,  0.0000000005796841340277581,  0.0000000003864560893518387,  0.00000000009661402233795968};
                            a = new double[] { 1.0, -3.983581258658522, 5.950878429266703, -3.951012436572837, 0.9837152675104801};
                            break;
                        case 1000:
                            b = new double[] { 0.000000000006063149982082905, 0.00000000002425259992833162, 0.00000000003637889989249743, 0.00000000002425259992833162, 0.000000000006063149982082905};
                            a = new double[] { 1.0, -3.991790624414473, 5.975405553386737, -3.975439152644423, 0.9918242237691696};
                            break;
                        case 1600:
                            b = new double[] { 0.00000000000092656438077654, 0.00000000000370625752310616, 0.00000000000555938628465924, 0.00000000000370625752310616,  0.00000000000092656438077654};
                            a = new double[] { 1.0, -3.994869139635089, 5.984620577672517,   -3.9846337166797, 0.9948822786570964};
                        break;
                        default:
                            println("EEG_Processing: *** ERROR *** Filters can only work at 125Hz, 200Hz, 250 Hz, 1000Hz or 1600Hz");
                            b = new double[] { 1.0 };
